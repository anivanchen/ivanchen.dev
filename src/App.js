          ...
          <div className="gallery-item">
            <div className="text-container" id="gallery">
              ...
              <div className="techs-container">
                ...
                <a className="tech-link" href="https://nodejs.org/en/"><i className="devicon-nodejs-plain" /></a>
                <a className="tech-link" href="https://reactjs.org/"><i className="devicon-react-plain" /></a>                  <a className="tech-link" href="https://postgresql.org/"><i className="devicon-postgresql-plain" /></a>
              </div>
            </div>
          </div>
          <div className="gallery-item">
