        ...
        <div className="opening-wrapper">
          ...
          <div className="opening-container">  
            <div className="text-container">
              <h2>Hi, I'm <a className="link" href="https://github.com/anivanchen">Ivan Chen</a>, a current sophomore at <a className="link" href="https://stuy.enschool.org/">Stuyvesant High School</a>.</h2>
