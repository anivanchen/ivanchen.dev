  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
          ...
          {socials.map((social, key) => (
            <div className={styles.link} key={key}>
              <a href={social.link} className={styles.inline}>
                <div><Image src={`/${social.name}.svg`} alt={social.name} width={14} height={14} layout="fixed" /></div>
                {social.name}
        ...
        <p>
          I’m a passionate software engineer and web developer who
          loves playing around with new technologies for fun. I enjoy
          playing around with IT and writing code to automate various
          actions I do on a daily basis. As a student, I don’t have
          much time to program every day, but I try my best to write
          at least a couple lines of code a day. I’m also an avid music
          listener.
        </p>
        ...
        <h2 className={styles.heading} id="fancy-text">Experience:</h2>
        {experience.map((job, key) => (
          <div className={styles.item} key={key}>
            <h3>{job.title} - <a href={job.link} id="fancy-text">{job.company}</a></h3>
        ...
        <div className={styles.centered}>
          <a href="mailto:ivanchen07@gmail.com">
            <div className={styles.button + " " + styles.centered}>
              <p>Contact Me</p>
              <div className={styles.icon}><Image src="/mail.svg" alt="link" height="14px" width="14px" /></div>
            </div>
          </a>
        </div>
      </main>
